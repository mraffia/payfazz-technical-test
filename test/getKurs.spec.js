...
describe('GET /api/kurs?startdate=1111-11-11&enddate=1111-11-11 (available)', function () {
  it('should respond with JSON object containing the firt Kurs data', function () {
    return request(app)
      .get('/api/kurs?startdate=1111-11-11&enddate=1111-11-11')
      .expect(200)
      .then(res => {
...
describe('GET /api/kurs?startdate=1111-11-12&enddate=1111-11-12 (not available)', function () {
  it('should respond with empty JSON object', function () {
    return request(app)
      .get('/api/kurs?startdate=1111-11-12&enddate=1111-11-12')
      .expect(200)
      .then(res => {
